...
for i in sender_node_id:
  os.system ("cat ../files-"+str(i)+"/var/log/*/* > "+"../results/cwnd_data/"+str(i))

for i in sender_node_id:
  in_filepath = "../results/cwnd_data/"+str(i)
  ...
  for socket in all_sockets:
    ...
    for info in socket:
      ...
      if "cwnd" in info:
        ...
        if port_found:
          with open("../results/cwnd_data/"+chr(i+63) + "-linux.plotme", write_mode) as out_file:
